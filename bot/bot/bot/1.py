    ...
    try:
        ...
        if success:
            result_text = (
                ...
                "Чтобы открыть каталог, напишите /katalog"
            )
        else:
...
#Keyboard        !!!!              !!!!           !!!!
from kb import ProductPagination
...
@router.callback_query(lambda c: c.data.startswith(('prev_','next_','buy_','favorite_','main_menu','no_action')))
